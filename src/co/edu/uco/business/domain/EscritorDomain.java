...
public class EscritorDomain {
	...
	public EscritorDomain(UUID identificador, TipoIdentificacionDomain tipoIdentificacion, String numeroIdentificacion,
			...
			boolean numeroTelefonoMovilEstaVerificado, EstadoEscritorDomain estado) {
		super();
	...
	public static final EscritorDomain getDefaultObject() {
